...
class RequestHeaderResolverTest {

  private static final RequestHeaderResolver target = new RequestHeaderResolver();
  ...
  interface Example {
    ...
    void methodA(@RequestHeader(name = "Authorization") String id, @RequestParam String name);
  }
}